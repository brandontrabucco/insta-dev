...
We are working together to complete a high-level directive. First, we aim to find the price of an addidas jacket on the addidas website, then we aim to estimate the monthly payment for a student loan of $50,000 at 5% interest over 10 years, and finally we aim to find a used sedan in the Pittsburgh area for under $10,000.
...
class ComposerJsonTaskParser(JsonTaskParser):
